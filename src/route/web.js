...
let initWebRoutes = (app) => {
  ...
  // router.post("/api/create-new-acc", userController.handleCreateNewAcc);
  ...
  router.post("/api/delete-schedule", doctorController.handleDeleteSchedule);
  router.get(
  ...
  //history doctor
  router.post(
    "/api/filter-history-doctor",
    doctorController.filterHistory
  );
  //history chua dc xac nhan boi bs
  router.post(
    "/api/filter-history-for-user",
    doctorController.filterHistoryForUser
  );
  //delete-booking-s1-s2
  router.post(
    "/api/deleteBookingS",
    doctorController.deleteBookingS
  );
  ...
  //filter chuyen khoa en
  router.post("/api/filter-specialtiesEn", specialtyController.filterSpecialtiesEn);
  router.get(
  ...
  router.post("/api/filter-clinicsEn", clinicController.filterClinicsEn);
  ...
  //admin history
  router.post(
    "/api/filter-history-all",
    adminController.filterHistoryAll
  );
  //router.post('/api/filter-by-patient-name', adminController.filterHistoryByNamePatient)
