          ...
          if (schedule.currentNumber < schedule.maxNumber) {
            ...
            if (user) {
              ...
              if (!created) {
                ...
                // Bản ghi đã tồn tại, bạn có thể thực hiện xử lý tại đây
                resolve({
                  errCode: 1,
                  errMessage: 'Email nay da dat lich hoac da xac nhan lich',
                ...
                resolve({
                  ...
                  data: booking // Bạn có thể trả về thông tin của bản ghi mới được tạo
                });
              }
            } else {
              resolve({
                errCode: -2,
                errMessage: 'Invalid user information',
              });
            }
          } else {
            resolve({
