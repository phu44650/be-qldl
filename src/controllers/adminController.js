...
let filterHistoryAll = async (req, res) => {
  try {
    let infor = await adminService.filterHistoryAllService(req.body);
    return res.status(200).json(infor);
  } catch (e) {
    console.log(e);
    return res.status(200).json({
...
module.exports = {
  ...
  getMonthlyRevenueSpecialty: getMonthlyRevenueSpecialty, filterHistoryAll
};
